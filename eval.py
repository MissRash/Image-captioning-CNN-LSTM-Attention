...
model = 'tutorial_model.tar'
word_map_file = 'data/WORDMAP_flickr8k_5_cap_per_img_5_min_word_freq.json'
beam_size = 1
...
def evaluate(beam_size):
    ...
    for i, (image, caps, caplens, allcaps) in enumerate(tqdm(loader, desc="EVALUATING AT BEAM SIZE " + str(beam_size))):
        ...
        while True:
            ...
            seqs = (torch.cat([seqs[prev_word_inds], torch.unsqueeze(next_word_inds, 1)], dim=1))  # (s, step+1)
